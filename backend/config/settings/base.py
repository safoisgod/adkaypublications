...
DATABASES = {
    'default': {
        'ENGINE': config('DB_ENGINE', default='django.db.backends.sqlite3'),  # DB_ENGINE,
        'NAME': config('DB_NAME'),
        'USER': config('DB_USER'),
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@publishinghouse.com')
ADMIN_EMAIL = config('ADMIN_EMAIL', default='admin@publishinghouse.com')
